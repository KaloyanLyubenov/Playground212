...
public class JwtService {
    ...
    private Claims extractAllClaims(String jwtToken){
        return Jwts
                .parserBuilder()
                .setSigningKey(getSigningKey()) // What we use to parse the claims with
                .build()
                .parseClaimsJws(jwtToken) // Where do we parse the claims for
                .getBody(); // Getting everything that got parsed
    }
